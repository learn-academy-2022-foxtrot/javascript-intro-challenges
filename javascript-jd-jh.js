...
console.log("LEARN".length === 5 && "Student".length === 7); // false
...
console.log(theQuestion + " " + theAnswer); // life, the universe, and everything 42
console.log(`${theQuestion} ${theAnswer}`); // life, the universe, and everything 42
...
console.log(theQuestion[0]); // l
console.log(theQuestion[theQuestion.indexOf("l")]); // l
