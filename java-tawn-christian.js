...
console.log("LEARN".indexOf("RN"))

// Does "LEARN" contain the subset "rn"?

console.log("LEARN".indexOf("rn")) // returns -1, so it does not contain the subset "rn".


// Does "LEARN"[0] strictly equal "l"?

console.log("LEARN"[0] === "l") // returns false because "LEARN" is uppercase.
...
if (theQuestion.length > theAnswer.length) {
    console.log("The Question is longer than the Answer")
}  else if (theAnswer.length < theQuestion) {
    console.log("The Answer is longer than the Question")
} else {
